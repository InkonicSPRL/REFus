 ...
 */
public class RefusWebException extends RuntimeException {
    ...
    public RefusWebException() {
    }

    public RefusWebException(int statuscode, String message, String messagekey){
     ...
     */
    public RefusWebException(String msg) {
        super(msg);
    }
